...
#.  The game ends in a draw, known as a cat's game, if no more empty squares
    remain and a player has failed to get three marks in a row. Examples of cat's
    ...
    ..  figure:: img/example-cats-games.*
        ...
        Examples of Tic Tac Toe games ending in a cats game. No player managed
